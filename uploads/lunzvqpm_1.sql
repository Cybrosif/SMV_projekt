...
CREATE TABLE `razredi` (
  ...
  `Kljuc_Vpisa` varchar(255) NOT NULL,
  `Ime_razreda` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `student_naloge` (
  `Student_Naloga_ID` int(11) NOT NULL,
...
CREATE TABLE `uporabniki` (
  ...
  `Vloga` enum('Administrator','Profesor','Dijak') DEFAULT 'Dijak',
...
(4, 'User1', 'Surname1', 'Profesor', 'password1', 'user1@example.com'),
...
--
ALTER TABLE `gradiva`
  MODIFY `Gradivo_ID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `naloge`
--
ALTER TABLE `naloge`
  MODIFY `Naloga_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `razredi`
--
ALTER TABLE `razredi`
  MODIFY `Razred_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `student_naloge`
--
ALTER TABLE `student_naloge`
  MODIFY `Student_Naloga_ID` int(11) NOT NULL AUTO_INCREMENT;
