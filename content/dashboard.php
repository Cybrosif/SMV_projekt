...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <h1 class="text-center text-primary mb-5">Nadzorna plošča</h1>
                            ...
                            if (isset($_SESSION['user_id'])) {
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo $naslov;
                                        echo '<span class="badge badge-primary badge-pill">' . date('d.m.Y', $datum_roka) . '</span>';
                                        echo '</a>';
                                    }
                                } else {
                                    echo '<div class="alert alert-warning">Ni rezultatov.</div>';
