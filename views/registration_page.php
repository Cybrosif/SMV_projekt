            ...
            <div class="card border-0">
                <div class="card-body">
                    <form action="" id="registrationForm">
                        ...
                        <input type="text" name="" id="ime" class="form-control my-4 py-2" placeholder="Ime" />
                        <input type="text" name="" id="priimek" class="form-control my-4 py-2" placeholder="Priimek" />
                        ...
                        <span id="passwordWarning" class="text-danger" style="margin-bottom: 215px;"></span><br>
